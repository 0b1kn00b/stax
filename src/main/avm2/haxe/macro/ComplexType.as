package haxe.macro {
	public final class ComplexType extends enum {
		...
		public static function TAnonymous(fields : Array) : ComplexType { return new ComplexType("TAnonymous",2,[fields]); }
		public static function TExtend(p : *, fields : Array) : ComplexType { return new ComplexType("TExtend",4,[p,fields]); }
		public static function TFunction(args : Array, ret : haxe.macro.ComplexType) : ComplexType { return new ComplexType("TFunction",1,[args,ret]); }
