package haxe.macro {
	...
	public final class ExprDef extends enum {
		...
		public static function EArrayDecl(values : Array) : ExprDef { return new ExprDef("EArrayDecl",6,[values]); }
		public static function EBinop(op : haxe.macro.Binop, e1 : *, e2 : *) : ExprDef { return new ExprDef("EBinop",2,[op,e1,e2]); }
		public static function EBlock(exprs : Array) : ExprDef { return new ExprDef("EBlock",12,[exprs]); }
		public static var EBreak : ExprDef = new ExprDef("EBreak",20);
		public static function ECall(e : *, params : Array) : ExprDef { return new ExprDef("ECall",7,[e,params]); }
		...
		public static function EDisplay(e : *, isCall : Boolean) : ExprDef { return new ExprDef("EDisplay",25,[e,isCall]); }
		...
		public static function ENew(t : *, params : Array) : ExprDef { return new ExprDef("ENew",8,[t,params]); }
		public static function EObjectDecl(fields : Array) : ExprDef { return new ExprDef("EObjectDecl",5,[fields]); }
		...
		public static function ESwitch(e : *, cases : Array, edef : *) : ExprDef { return new ExprDef("ESwitch",17,[e,cases,edef]); }
		...
		public static function ETry(e : *, catches : Array) : ExprDef { return new ExprDef("ETry",18,[e,catches]); }
		public static function EType(e : *, field : String) : ExprDef { return new ExprDef("EType",29,[e,field]); }
		public static function EUnop(op : haxe.macro.Unop, postFix : Boolean, e : *) : ExprDef { return new ExprDef("EUnop",9,[op,postFix,e]); }
		public static function EUntyped(e : *) : ExprDef { return new ExprDef("EUntyped",22,[e]); }
		public static function EVars(vars : Array) : ExprDef { return new ExprDef("EVars",10,[vars]); }
		public static function EWhile(econd : *, e : *, normalWhile : Boolean) : ExprDef { return new ExprDef("EWhile",16,[econd,e,normalWhile]); }
		public static var __constructs__ : Array = ["EConst","EArray","EBinop","EField","EParenthesis","EObjectDecl","EArrayDecl","ECall","ENew","EUnop","EVars","EFunction","EBlock","EFor","EIn","EIf","EWhile","ESwitch","ETry","EReturn","EBreak","EContinue","EUntyped","EThrow","ECast","EDisplay","EDisplayNew","ETernary","ECheckType","EType"];;
	}
}
