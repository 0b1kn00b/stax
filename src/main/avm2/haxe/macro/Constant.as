package haxe.macro {
	public final class Constant extends enum {
		...
		public static function CType(s : String) : Constant { return new Constant("CType",5,[s]); }
		public static var __constructs__ : Array = ["CInt","CFloat","CString","CIdent","CRegexp","CType"];;
	}
}
