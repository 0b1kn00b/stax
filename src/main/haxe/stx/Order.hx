...
class Order {
  ...
  static public function nil<A>(a:A,b:A):Int{
    return __order__(function(a:A, b:A):Int { except()(IllegalOperationError("at least one of the arguments should be null")); return 0;})(a,b);
  } 
  ...
  static public function getOrderForType<T>(v: ValueType): Ord<T> {
    return switch(v) {
      ...
      case TNull      :  nil;
      case TFunction  : __order__(function(x,y){ except()(IllegalOperationError("unable to compare on a function")); return 0; });
    }
  }
}
class EnumOrder{
