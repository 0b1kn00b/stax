...
class Hasher {
  ...
  public static function getHashForType<T>(v: ValueType) : T->Int {
    return switch(v) {
      ...
      case TUnknown         : __hash__(function(v: T) {except()(IllegalOperationError("can't retrieve hashcode for TUnknown: $v")); return 0;});
      case TObject          :
        __hash__(function(v){
      ...
      case TFunction        : __hash__(function(v : T):Int {except()(IllegalOperationError("function can't provide a hash code")); return 0;});
      case TNull            : nil;
    }
	}
