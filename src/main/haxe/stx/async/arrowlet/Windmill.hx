...
abstract Windmill<S,A>(ArrowletWindmill<S,A>) from ArrowletWindmill<S,A> to ArrowletWindmill<S,A>{
  ...
  static public function mill<S,A>(?arw:ArrowletState<S,Chunk<A>>):Windmill<S,A>{
  ...
  @:noUsing static public function seed<S,A>(arw:Arrowlet<S,Chunk<A>>):Windmill<S,A>{
    var arw : Arrowlet<S,Tuple2<Chunk<A>,S>> = 
    function(x){
  ...
  public function new(?v){
    this = ntnl().apply(v) ? v : 
      StateArrowlets.edit(StateArrowlets.unit(),
        function(x:Chunk<A>){
          return x == null ? Nil : x;
        }
      );
  ...
  public function access<B>(a1:Arrowlet<Tuple2<A,S>,Chunk<B>>):Windmill<S,B>{
    return new Windmill(
      function(s:S){
  ...
  public function accessOption<B>(a1:Arrowlet<Tuple2<Option<A>,S>,Chunk<B>>):Windmill<S,B>{
    return new Windmill(
      function(s:S){
        var vals : Eventual<Tuple2<Chunk<A>,S>> = this.apply(s);
        return vals.flatMap(
  ...
  public function change(a1:Arrowlet<Tuple2<A,S>,S>):Windmill<S,A>{
    return new Windmill(
      this.then(
  ...
  public function attempt<B>(arw:Arrowlet<A,Chunk<B>>):Windmill<S,B>{
    return new Windmill(
      this.then(
        function(l:Chunk<A>,s:S){
          return switch (l){
  ...
  public function recover(arw:Arrowlet<Fail,Chunk<A>>):Windmill<S,A>{
    return this.then(
  ...
  public function operate(arw:Arrowlet<A,Option<Fail>>):Windmill<S,A>{
    return access(
      function(e:A,s:S){
  ...
  public function drawWith<B,C>(a:Arrowlet<S,Chunk<B>>,fn:A->B->C):Windmill<S,C>{
    return access(
      a.second()
      .then(
  ...
  public function draw<B>(a:Arrowlet<S,Chunk<B>>):Windmill<S,Tuple2<A,B>>{
    return drawWith(a,tuple2);
  }
  public function exchange<B>(a:Arrowlet<S,Chunk<B>>):Windmill<S,B>{
    return StateArrowlets.access(
      this,
  ...
  public function edit<B>(a1:Arrowlet<A,B>):Windmill<S,B>{
    return new Windmill(
      this.then(
        Crank.fromArrowlet(a1).first()
      )
    );
  }
  ...
  public function withInput(?i : S, cont : Tuple2<Chunk<A>,S> -> Void):Void{
    this.withInput(i,cont);
  }
}
class Windmills{
  static public function request<S,A>(arw0:Windmill<S,A>,i:S):Eventual<Chunk<A>>{
    var evt : Eventual<Chunk<A>> = StateArrowlets.request(arw0,i);
    return evt;
  }
  ...
  static public function toWindmill<S,A>(arw:Arrowlet<S,Chunk<A>>):Windmill<S,A>{
    var arw1 : Arrowlet<S,Tuple2<Chunk<A>,S>> 
      = function(s:S):Eventual<Tuple2<Chunk<A>,S>>{
          return arw.apply(s).map(tuple2.bind(_,s));
        };
    return arw1;
  }
  static public function breakout<S,A>(arw:Windmill<S,A>):Arrowlet<S,Chunk<A>>{
    return arw.then(
      function(a:Chunk<A>,s:S){
        return a;
      }.tupled()
