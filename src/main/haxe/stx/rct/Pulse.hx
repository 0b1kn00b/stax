...
class PulseTypes {
    ...
    public static function time<T>(pulse : Pulse<T>) : Float return Enums.byIndex(pulse, 0);

    public static function value<T>(pulse : Pulse<T>) : T return Enums.byIndex(pulse, 1);
