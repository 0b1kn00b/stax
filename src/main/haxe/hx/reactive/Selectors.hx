...
typedef SelectorsType<I,O>      = Array<Dispatch<I,O>>;

abstract Selectors<I,O>(SelectorsType<I,O>) from SelectorsType<I,O> to SelectorsType<I,O>{
  public function new(){
    this = [];
  }
  ...
  public function copy():Selectors<I,O>{
    return this.copy();
  }
