...
class ObserverBase<T> implements Observer<T>{
  ...
  @doc("Core implementation of IDisposable.")
  @params(["disposing","true if the Dispose call was triggered by the IDisposable.Dispose method; false if it was triggered by the finalizer"])
