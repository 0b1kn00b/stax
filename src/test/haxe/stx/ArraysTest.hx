...
class ArraysTest extends Suite {
  ...
  public function testExistsP(u:TestCase):TestCase {
  ...
  public function testToList(u:TestCase):TestCase {
  ...
  public function testToSet(u:TestCase):TestCase {
  ...
  public function testGroupBy(u:TestCase):TestCase {
  ...
  public function testPad(u:TestCase):TestCase{
    var arr = [1,2,3,4];
        arr = arr.pad(6);
